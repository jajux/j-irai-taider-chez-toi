              ...
              <div class="mj-column-per-100 mj-outlook-group-fix" style="font-size:0px;text-align:left;direction:ltr;display:inline-block;vertical-align:top;width:100%;">
                <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="vertical-align:top;" width="100%">
                  <tbody>
                    ...
                    <tr>
                      <td align="center" style="font-size:0px;padding:10px 25px;padding-right:25px;padding-left:25px;word-break:break-word;">
                        <div style="font-family:Helvetica;font-size:20px;line-height:1;text-align:center;color:#FFFFFF;">Merci d'avoir effectué une demande de réservation</div>
                      </td>
                    </tr>
                  </tbody>
                </table>
                      ...
                      <td align="left" style="font-size:0px;padding:10px 25px;padding-top:10px;padding-right:25px;padding-left:25px;word-break:break-word;">
                        <div style="font-family:Helvetica;font-size:16px;line-height:1;text-align:left;color:#FFFFFF;">@if($order->payment === 'cheque') <p>Veuillez nous envoyer un chèque avec :</p>
                          <ul>
                            ...
                            <li>payable à l'ordre de <strong>{{ $resa->firstname }}</strong></li>
                            <li>à envoyer à <strong>{{ $resa->address }}</strong></li>
                            <li>n'oubliez pas d'indiquer votre référence de commande <strong>{{ $order->reference }}</strong></li>
                          </ul> @if($order->pick) <p><strong>Vous pourrez venir chercher votre commande dès réception du paiement.</strong></p> @else <p><strong>Votre commande vous sera envoyée dès réception du paiement.</strong>.</p> @endif Pour toute question ou information complémentaire merci de contacter notre <a href="mailto:{{ $resa->email }}">support client</a>. @endif @if($order->payment === 'mandat') <p>Vous avez choisi de payer par mandat administratif. Ce type de paiement est réservé aux administrations.</p>
                          <p>Vous devez envoyer votre mandat administratif à :</p>
                          <p><strong>{{ $resa->firstname }}</strong></p>
                          <p><strong>{{ $resa->address }}</strong></p>
                          <p>Vous pouvez aussi nous le transmettre par e-mail à cette adresse : <strong>{{ $resa->email }}</strong></p>
                          <p>N'oubliez pas d'indiquer votre référence de commande <strong>{{ $order->reference }}</strong>.</p> @if($order->pick) <p><strong>Vous pourrez venir chercher votre commande dès réception du mandat.</strong></p> @else <p><strong>Votre commande vous sera envoyée dès réception du mandat.</strong>.</p> @endif Pour toute question ou information complémentaire merci de contacter notre <a href="mailto:{{ $resa->email }}">support client</a>. @endif @if($order->payment === 'virement') <p>Veuillez effectuer un virement sur notre compte :</p>
                          <ul>
                            <li>montant du virement : <strong>{{ number_format($order->totalOrder, 2, ',', ' ') }} €</strong></li>
                            <li>titulaire : <strong>{{ $resa->holder }}</strong></li>
                            <li>BIC : <strong>{{ $resa->bic }}</strong></li>
                            <li>IBAN : <strong>{{ $resa->iban }}</strong></li>
                            <li>banque : <strong>{{ $resa->bank }}</strong></li>
                            <li>adresse banque : <strong>{{ $resa->bank_address }}</strong></li>
                            <li>n'oubliez pas d'indiquer votre référence de commande <strong>{{ $order->reference }}</strong></li>
                          </ul> @if($order->pick) <p><strong>Vous pourrez venir chercher votre commande dès réception du paiement.</strong></p> @else <p><strong>Votre commande vous sera envoyée dès réception du paiement.</strong>.</p> @endif Pour toute question ou information complémentaire merci de contacter notre <a href="mailto:{{ $resa->email }}">support client</a>. @endif @if($order->payment === 'carte') <p>Vous avez choisi de payer par carte bancaire. Nous vous transmettrons un email de confirmation dès que votre réglement aura été effectué.</p> @if($order->pick) <p><strong>Vous pourrez venir chercher votre commande dès réception du paiement.</strong></p> @else <p><strong>Votre commande vous sera envoyée dès réception du paiement.</strong>.</p> @endif Pour toute question ou information complémentaire merci de contacter notre <a href="mailto:{{ $resa->email }}">support client</a>. @endif
                        </div>
                      </td>
                    </tr>
                  </tbody>
                  ...
                  <tbody>
                    <tr>
                      <td align="center" style="font-size:0px;padding:10px 25px;padding-top:20px;padding-right:25px;padding-bottom:20px;padding-left:25px;word-break:break-word;">
                        <div style="font-family:Helvetica;font-size:15px;line-height:1;text-align:center;color:#555555;">{{ $resa->name }}</div>
                      </td>
                    </tr>
                  </tbody>
                </table>
